...
public final class ActivityManageClassesBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityManageClassesBinding(@NonNull RelativeLayout rootView,
      @NonNull Button addClassButton, @NonNull CheckBox checkFriday, @NonNull CheckBox checkMonday,
      @NonNull CheckBox checkSaturday, @NonNull CheckBox checkSunday,
      @NonNull CheckBox checkThursday, @NonNull CheckBox checkTuesday,
      @NonNull CheckBox checkWednesday, @NonNull LinearLayout checkboxGroup,
      @NonNull EditText editCourseName, @NonNull EditText editLocation, @NonNull EditText editTime,
      @NonNull Spinner spinnerAMPM) {
  ...
  @NonNull
  public static ActivityManageClassesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityManageClassesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_manage_classes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityManageClassesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityManageClassesBinding((RelativeLayout) rootView, addClassButton,
          checkFriday, checkMonday, checkSaturday, checkSunday, checkThursday, checkTuesday,
          checkWednesday, checkboxGroup, editCourseName, editLocation, editTime, spinnerAMPM);
    }
